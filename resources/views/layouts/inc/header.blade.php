<div class="header">
    ...
    <a class="header-link {{ request()->is('student/dashboard')?'active':'' }} {{ request()->is('homepage')?'active':'' }}" href="{{ url('admin/home') }}"><svg viewBox="-6 0 512 512" fill="currentColor">
            <path
    ...
    <a class="header-link {{ request()->is('student/my-units')?'active':'' }}"   href="{{ url('admin/technicians') }}"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
    ...
    <a class="header-link" href="{{ url('admin/firms') }}" ><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
            <path
    ...
    <a class="header-link" href="{{ url('admin/users') }}"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
            <path
