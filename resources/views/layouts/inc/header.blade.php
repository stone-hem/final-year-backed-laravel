<div class="header">
    <div class="logo">Mechanic
        <span class=logo-det>Auto</span>
    </div>
    <a class="header-link {{ request()->is('admin/home')?'active':'' }} {{ request()->is('homepage')?'active':'' }}" href="{{ url('admin/home') }}"><svg viewBox="-6 0 512 512" fill="currentColor">
            <path
    ...
    <a class="header-link {{ request()->is('admin/technicians')?'active':'' }}"   href="{{ url('admin/technicians') }}"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
    ...
    <a class="header-link {{ request()->is('admin/firms')?'active':'' }}"  href="{{ url('admin/firms') }}" ><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
            <path
    ...
    <a class="header-link {{ request()->is('admin/reports')?'active':'' }}"  href="{{ url('admin/reports') }}"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
            fill="currentColor">
            <path
    ...
    <div class="user-info">
        ...
        <div class="hour" id="live-time">0000 hrs</div>
    </div>
</div>
